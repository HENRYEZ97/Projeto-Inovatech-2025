...
const locais = ["São José Operário 2", "Jorge Teixeira", "Cidade Nova", "Japiim"];
 ...
 <div className="flex justify-between items-center p-6 border-b border-gray-200 bg-gradient-to-br from-blue-400 to blue-600">
  <h2 className="text-lg font-semibold text-white cursor-pointer">Localidades</h2>
    <button onClick={onClose}
      className="text-blue-500 hover:text-blue-200 text-xl cursor-pointer font-bold p-1 rounded-full hover:bg-blue-700 w-8 h-8 flex items-center justify-center">
        ...
        <li
        key={local}
        className="cursor-pointer text-slate-500 p-3 rounded-lg bg-gradient-to-br from-gray-400 to blue-600 hover:text-white transition-all duration-200 border-transparent hover:border-blue-200 font-bold"
        >
